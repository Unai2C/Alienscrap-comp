...
const RAW_TEMPLATES: Record<TemplateId, SlotDefinition[]> = {
  ...
  FLYING_SAUCER: [
    { slotId: 'fs0',  requiredPart: 'CUBE',     position: { x: 8,   y: TEMPLATE_BASE_Y + 0.9,  z: 8   }, scale: { x: 2.8, y: 0.25, z: 0.9 }, label: 'Central Beam' },
    { slotId: 'fs1',  requiredPart: 'CYLINDER', position: { x: 8,   y: TEMPLATE_BASE_Y + 1.0,  z: 8   }, scale: { x: 3.2, y: 0.25, z: 3.2 }, label: 'Outer Ring' },
    { slotId: 'fs2',  requiredPart: 'CYLINDER', position: { x: 8,   y: TEMPLATE_BASE_Y + 1.25, z: 8   }, scale: { x: 2.1, y: 0.45, z: 2.1 }, label: 'Core Ring' },
    { slotId: 'fs3',  requiredPart: 'CONE',     position: { x: 8,   y: TEMPLATE_BASE_Y + 1.9,  z: 8   }, scale: { x: 1.6, y: 0.75, z: 1.6 }, label: 'Dome Base' },
    { slotId: 'fs4',  requiredPart: 'CONE',     position: { x: 8,   y: TEMPLATE_BASE_Y + 2.35, z: 8   }, scale: { x: 0.8, y: 0.5,  z: 0.8 }, label: 'Dome Top' },
    { slotId: 'fs5',  requiredPart: 'CYLINDER', position: { x: 8,   y: TEMPLATE_BASE_Y + 0.45, z: 9.4 }, scale: { x: 0.45,y: 0.45, z: 0.45}, label: 'Thruster Front' },
    { slotId: 'fs6',  requiredPart: 'CYLINDER', position: { x: 6.8, y: TEMPLATE_BASE_Y + 0.45, z: 7.3 }, scale: { x: 0.45,y: 0.45, z: 0.45}, label: 'Thruster Left' },
    { slotId: 'fs7',  requiredPart: 'CYLINDER', position: { x: 9.2, y: TEMPLATE_BASE_Y + 0.45, z: 7.3 }, scale: { x: 0.45,y: 0.45, z: 0.45}, label: 'Thruster Right' },
    { slotId: 'fs8',  requiredPart: 'CONE',     position: { x: 6.7, y: TEMPLATE_BASE_Y + 0.65, z: 9.7 }, scale: { x: 0.28,y: 0.28, z: 0.28}, label: 'Light Front Left' },
    { slotId: 'fs9',  requiredPart: 'CONE',     position: { x: 9.3, y: TEMPLATE_BASE_Y + 0.65, z: 9.7 }, scale: { x: 0.28,y: 0.28, z: 0.28}, label: 'Light Front Right' },
    { slotId: 'fs10', requiredPart: 'CONE',     position: { x: 6.7, y: TEMPLATE_BASE_Y + 0.65, z: 6.3 }, scale: { x: 0.28,y: 0.28, z: 0.28}, label: 'Light Back Left' },
    { slotId: 'fs11', requiredPart: 'CONE',     position: { x: 9.3, y: TEMPLATE_BASE_Y + 0.65, z: 6.3 }, scale: { x: 0.28,y: 0.28, z: 0.28}, label: 'Light Back Right' },
    { slotId: 'fs12', requiredPart: 'CYLINDER', position: { x: 8,   y: TEMPLATE_BASE_Y + 2.7,  z: 8   }, scale: { x: 0.1, y: 0.45, z: 0.1 }, label: 'Antenna Base' },
    { slotId: 'fs13', requiredPart: 'CONE',     position: { x: 8,   y: TEMPLATE_BASE_Y + 3.05, z: 8   }, scale: { x: 0.18,y: 0.18, z: 0.18}, label: 'Antenna Tip' }
  ],
  CASTLE_KEEP: [
